...
UPDATE_EVERY = 10  # UPDATE FREQUENCY: how often to update the network
...
class DQNAgent():
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        #we only add to the memory buffer if we received an actual feedback
    ...
    def learn(self, experiences, gamma): 
        ...
        #Q_targets = rewards #no bootstrap value
