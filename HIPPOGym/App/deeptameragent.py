...
class TamerAgent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        # Q-Network
        self.qnetwork_local = HNetwork(state_size, action_size, seed).to(device)
        self.qnetwork_target = HNetwork(state_size, action_size, seed).to(device)
    ...
    def step(self, feedback):
        ...
        if self.t_step == 0: #or feedback_given == True:
